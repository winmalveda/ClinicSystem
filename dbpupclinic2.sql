...
CREATE TABLE `tbcategory` (
  `id` int(11) NOT NULL,
  `No` varchar(22) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `tbcategory` (`id`, `No`, `category`) VALUES
(1, 'I', 'ANTI-PYRETIC'),
(2, 'II', 'ANALGESIC/ANTI-INFLAM'),
(3, 'III', 'COUGH/COLDS'),
(4, 'IV', 'ANTI-EMETIC'),
(5, 'V', 'ANTI-HISTAMINE'),
(6, 'VI', 'ANTI-HYPERTENSIVE'),
(7, 'VII', 'ANTI-SPASMODIC'),
(8, 'VIII', 'ANTIDIARREAL'),
(9, 'IX', 'ANTI-BACTERIAL'),
(10, 'X', 'ANTI-ACIDS'),
(11, 'XI', 'ORAL REHYDRATION'),
(12, 'XII', 'ANTI-VERTIGO'),
(13, 'XIII', 'MEDICAL SUPPLIES');
...
(1, 'ANTI-PYRETIC', '2019-04-28', 'PARACETAMOL(MYREMOL)', 274, 72, 202, 'tabs'),
...
(19, '2019-04-27 07:41:54', 'Sherwin Malveda', 'BSIT 1-1', 'COUGH/COLDS', 'PARACETAMOL(MYREMOL)'),
(21, '2019-04-27 12:34:04', 'Win', 'BSIT 4-1', 'ANTI-PYRETIC', 'PARACETAMOL(MYREMOL)');
